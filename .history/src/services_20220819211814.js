...
const loginWithGoogle = () => {
  return signInWithPopup(auth, providerGoogle).then((e) => console.log(e));
};
const loginWithFacebook = () => {
  return signInWithPopup(auth, providerFacebook).then((e) => console.log(e));
};
const loginWithGithub = () => {
  return signInWithPopup(auth, Github).then((e) => console.log(e));
};
