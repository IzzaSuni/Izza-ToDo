        ...
        <Box marginY={3}>
          <form onSubmit={submit}>
            ...
            <Box
              ...
              py={2}
            >
              <Img onClick={loginWithFacebook} src="/facebook.svg" px={"8px"} />
              <Img onCLick={loginWithGoogle} src="/google.svg" px={"8px"} />
              <Img src="/Github.svg" px={"8px"} onCLick={loginWithGithub} />
            </Box>
